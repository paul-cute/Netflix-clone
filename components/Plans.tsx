...
function Plans({products}: Props) {
    ...
    const [selectedPlan, setSelectingPlan] = useState<Product | null>(products[2])
  ...
  return (
    <div>
        ...
        <main className='pt-28 max-w-5xl pb-12 transition-all md:px-10 mx-auto'>
                ...
                <div className='flex w-full items-center justify-end self-end md:w-3/5'>
                   {products.map((product) => (
                    <div key={product.id} 
                        ...
                        onClick={() => setSelectingPlan(product)}>
                        {product.name}
                    </div>
                   ))}
                </div>
